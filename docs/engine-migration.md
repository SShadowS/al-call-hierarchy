...
| L5 (detectors) | **R4-D…G** (capability-query / record-flow / ordering-facts / path-walker — + the deferred d13/d16) | IN PROGRESS — R4-D next; needs the cross-app L5 pipeline entry (`build_r3a5_cross_app_base` → detectors) for d13/d16 + the cross-app capability surface |
| product | — | not started |
